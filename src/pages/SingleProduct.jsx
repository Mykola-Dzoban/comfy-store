...
import { formatPrice, fetchData, generateAmountOptions } from "../utils";
...
export const loader = async ({ params }) => {
  const resp = await fetchData(`/products/${params.id}`);
  return { product: resp.data.data.attributes, id: resp.data.data.id };
};
